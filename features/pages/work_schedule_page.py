...
class WorkSchedulePage:
    ...
    def __init__(self):
        ...
        self.holiday_check_2 = Element("div.components_day.monthDay.nonWorking.corporateHoliday:nth-child(14)", "css",
                                       "corp day 10 november")
        self.holiday_check_3 = Element("//div[contains(text(),'First_January')]", "xpath", "custom holiday name")
        ...
        self.holiday_name = TextField(".with-navigation.ext-chrome:nth-child(2) div.corporateHolidayEditor:nth-child("
                                      "9) div.editorSection div.titleInput > input:nth-child(1)", "css",
                                      "holiday name field")
        self.holiday_list = Button("//div[contains(@class,'components_button list')]", "xpath", "holiday list")
        self.name_field = Button("//div[contains(text(),'First_January')]", "xpath", "field for delete icon")
