...
class UserListPage:
    ...
    def __init__(self):
        ...
        self.custom_access_to_scope = Button(".editManagementAssignmentsPanel .customSection>label", "css",
                                             "custom access to scope of work")
        self.access_to_scope_back_button = Button(
            ".editManagementAssignmentsPanel .managementAssignmentsPanel .backButton", "css",
