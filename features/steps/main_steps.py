...
@given("I open I open actiPLANS page")
def step_impl(context):
    """
    :type context: behave.runner.Context
    """
    raise NotImplementedError(u'STEP: Given I open I open actiPLANS page')


@step("I am on aP_leaves_management")
def step_impl(context):
    """
    :type context: behave.runner.Context
    """
    raise NotImplementedError(u'STEP: And I am on aP_leaves_management')
