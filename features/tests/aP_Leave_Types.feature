Feature: aP Leave Types settings
  ...
  @smoke
  Scenario: Create leave type in actiPLANS
  ...
  @smoke
  Scenario: Change leave type in actiPLANS
  ...
  @smoke
  Scenario: Move leave type in actiPLANS
    When I click order_button
    And I wait 2 seconds for animation stops
    Then moved_order should contain 4

  @smoke
  Scenario: Delete leave type in actiPLANS
