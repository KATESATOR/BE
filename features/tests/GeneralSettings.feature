Feature: General settings interface by admin
  ...
  Scenario: General settings: calendar layout
    ...
    And i click gs_save
    Then I should see a text Sunday on the page
  ...
  Scenario: General settings: time zone group
    ...
    And i click gs_data_settings_tzg
  ...
  Scenario: General settings: maximum reported hours
    ...
    And i click gs_save
    Then i click gs_work_schedule_hours_per_day_limit
    And i click gs_save
  ...
  Scenario: General settings: pto balance
    ...
    And i click gs_save
    Then i should see a text 2.5 on the page
  ...
  Scenario: General settings: sick balance
    ...
    And i click gs_save
    Then i should see a text 1.5 on the page
  ...
  Scenario: General settings: data access restrictions
    ...
    And i click gs_dar_see_all_tt_selector_timmers
